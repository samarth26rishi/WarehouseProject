...
def answer_question(question):
    ...
    #
    # This requires a reachable Ollama server. If none is
    # configured/running (e.g. this deployment intentionally
    # skips it), fail gracefully instead of surfacing a raw
    # connection error / 500 to the caller.
    # -----------------------------------------------------
    ...
    try:
        ...
        return (
            "I can answer direct questions about event counts, "
            "behaviours, bays, and risk levels right now. "
            "Open-ended analysis needs the AI model, which isn't "
            "connected on this deployment — try a more specific "
            "question about the shift data instead."
        )
